    ...
    <x-container>
        ...
        <div class="relative pt-36 min-h-screen">
            <div class="flex flex-col md:flex-row gap-4 justify-between">
                <div class=" max-w-4xl">
                    <x-heading.heading1 class="lg:!text-4xl">Tags</x-heading.heading1>
                    <x-paragraph.paragraph class="mt-1">
                        Jelajahi berbagai artikel kami berdasarkan tag yang mengelompokkan topik serupa. Setiap artikel
                        juga memiliki berbagai kategori yang lebih spesifik, membantu Anda menemukan konten teknologi
                        yang relevan dengan mudah.
                ...
                <div class="flex justify-end">
                    <x-aksi.dropdown :title="'Filter'">
                        <div class="p-4 flex flex-col ">
                            ...
                            <x-aksi.dropdownOption
                                href="{{ route('tags', ['sortBy' => 'terbanyak']) }}">Terbanyak</x-aksi.dropdownOption>
                            <x-aksi.dropdownOption
                                href="{{ route('tags', ['sortBy' => 'tersedikit']) }}">Tersedikit</x-aksi.dropdownOption>
                            <x-aksi.dropdownOption
                                href="{{ route('tags', ['sortBy' => 'terbaru']) }}">Terbaru</x-aksi.dropdownOption>
                            <x-aksi.dropdownOption :navigate="false" data-hs-overlay="#kategori"
                                class="cursor-pointer">Kategori</x-aksi.dropdownOption>
                            <x-aksi.dropdownOption href="{{ route('tags') }}"
