                    ...
                    <div class="relative z-10">
                        <p class="text-xl text-gray-800">
                            <em class="relative">
                                ...
                                <span class="relative z-10 dark:text-white leading-loose">Kesulitan bukanlah hal yang mustahil untuk dilewati, Hanya butuh kemauan lebih untuk menghadapi</span>
                            </em>
                        </p>
                    </div>
                </blockquote>

                {{-- <x-heading.heading1 class="">
                    Kategori Favorit
                </x-heading.heading1>
                <div class="grid grid-cols-2 gap-4 md:grid-cols-2 xl:grid-cols-4 py-4 mt-8  ">
                    <a href=""
                        class="dark:bg-mainDark2 hover:bg-gray-200 dark:hover:bg-mainDark1 border-[1px] dark:border-borderDark inline-block text-center p-4 rounded-lg">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Laravel</h6>
                    </a>
                    <a href=""
                        class="dark:bg-mainDark2 hover:bg-gray-200 dark:hover:bg-mainDark1 border-[1px] dark:border-borderDark inline-block text-center p-4 rounded-lg">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Livewire</h6>
                    </a>
                    <a href=""
                        class="dark:bg-mainDark2 hover:bg-gray-200 dark:hover:bg-mainDark1 border-[1px] dark:border-borderDark inline-block text-center p-4 rounded-lg">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Restfull Api</h6>
                    </a>
                    <a href=""
                        class="dark:bg-mainDark2 hover:bg-gray-200 dark:hover:bg-mainDark1 border-[1px] dark:border-borderDark inline-block text-center p-4 rounded-lg">
                        <h6 class="text-lg font-semibold text-gray-700 dark:text-white">Tips & Trik</h6>
                    </a>
                </div> --}}
            </div>
        </div>
