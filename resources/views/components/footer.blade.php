{{-- <footer class="py-20 md:py-40 bg-white dark:bg-mainDark relative ">
    ...
    <div class="absolute opacity-15 bottom-2 xl:bottom-5 left-[50%] transform -translate-x-1/2  w-full m-0">
        <h1 class="text-gray-900 dark:text-white text-7xl md:text-[100px] xl:text-[250px] font-bold text-center"><span class="text-primary">Go</span>-Blog</h1>
    </div>
    <x-container>
        <div class="m-auto  from md:w-10/12 lg:w-8/12 xl:w-6/12 relative ">
...
<!-- ========== FOOTER ========== -->
<footer class="mt-auto w-full bg-white dark:bg-mainDark relative">
        ...
        <div class="mt-auto w-full  py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                <div class="col-span-full lg:col-span-1">
                    <a class="flex-none text-xl font-semibold text-white" href="#" aria-label="{{ config('app.name') }}">{{ config('app.name') }}</a>
                </div>
                <!-- End Col -->
                ...
                <div class="col-span-2">
                    ...
                    <form>
                        <div
                            ...
                            <a class="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
                                href="#">
                                Subscribe
                            </a>
                        </div>
